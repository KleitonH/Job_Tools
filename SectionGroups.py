...
grupos = {
    ...
    'laterais': {
        ...
        'subgrupos': {
            ...
            'vidros_encapsulado': {'codigo': '0007', 'itens': ['VIDRO ENCAPSULADO']},
        }
    },
    #BATERIAS
    'baterias_startstop': {
    ...
    'cabos': {
        ...
        'subgrupos': {
            ...
            'cabos_fechadura': {'codigo': '0019', 'itens': ['CABO COMANDO FECHADURA', 'CABO FECHADURA']},
            'cabos_macaneta': {'codigo': '0232', 'itens': ['CABO ACION MACANETA', 'CABO ACO LIGACAO MACANETA', 'CABO DESTRAVA PORTA', 'CABO MACANETA']},
            'cabos_maquina_vidro': {'codigo': '0232', 'itens': ['CABO ACION MACANETA', 'CABO ACO LIGACAO MACANETA', 'CABO DESTRAVA PORTA', 'CABO MACANETA']},
            'cabos_trava_banco': {'codigo': '0233', 'itens': ['CABO MAQUINA VIDRO']},
    ...
    'reparos': {
        ...
        'subgrupos': {
            ...
            'kit_reparo_maquina_vidro': {'codigo': '0058', 'itens': ['ARRASTE MAQ VIDRO', 'ARRASTE MAQUINA VIDRO', 'KIT REPARO MAQUINA VIDRO']},
    ...
    'suspensao': {
        'codigo': '0033',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['EMBUCHAMENTO', 'CALCO AJUSTE', 'CALCO AMORT', 'CALCO BATENT', 'CALCO CAMBAGEM', 'CUPILHA', 'EIXO BANDEJA TRAS', 'EIXO TENSOR', 'ESPACADOR ANEL VEDADOR', 'ESPACADOR ROLAMENTO', 'FACAO SUSPENS', 'MONTANTE', 'PARAFUSO BANDEJA', 'PARAFUSO EIXO TRAS', 'PORCA AMORTECEDOR', 'SUPORTE AMORTECEDOR DIANT', 'TELEFONE PINO ROLAMENTO', 'TIRANTE SUSPENSAO']},
...
#Sessão Elétrica
    ...
    'amortecedores_abertura': {
        ...
        'subgrupos': {
            ...
            'amortecedores_capo': {'codigo': '0226', 'itens': ['ALAVANCA ABERTURA', 'ALAVANCA ACION FECHADURA', 'ALAVANCA CABO CAPO', 'ALAVANCA CAPO' , 'ALAVANCA TAMPA', 'ALAVANCA MACANETA ABERTURA']},
        }
    },
    'arruelas': {
        'codigo': '0064',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['ARRUELA', 'ARRUELA AJUSTE', 'ARRUELA ATRITO', 'ARRUELA ESPACADORA', 'ARRUELA LISA', 'ARRUELA MANGA', 'ARRUELA PINO', 'AAUELA TRAVA']},
        }
    },
    'barras_limpador': {
        'codigo': '0065',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['BARRA LIMPADOR']},
        }
    },
    'batentes_impacto': {
        'codigo': '0066',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['BATENTE RUIDO', 'BATENTE CAPO', 'BATENTE COLUNA', 'BATENTE DO CAPO', 'BATENTE ENCOSTO BANCO', 'BATENTE PORTA', 'BATENTE FECHADURA', 'BATENTE PORTA MALA', 'BATENTE LATERAL CAPO', 'BATENTE TAMPA', 'BATENTE TRASEIRO', 'BATENTE TAMPA TRAS', 'CHAPA BATENTE PORTA', 'COXIM BATENTE TAMPA', 'COXIM BATENTE', 'ENCOSTO BATENTE PORTA']},
        }
    },
    'bujoes': {
        'codigo': '0069',
    ...
    'guias_ferragens': {
        ...
        'subgrupos': {
            ...
            'guias_vidro': {'codigo': '0240', 'itens': ['MECANISMO GUIA VIDRO']},
        }
    },
    'macanetas_alavancas': {
        'codigo': '0062',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': []},
            'alavancas_abertura': {'codigo': '0224', 'itens': ['ALAVANCA ABERTURA', 'ALAVANCA ACION FECHADURA', 'ALAVANCA CABO CAPO', 'ALAVANCA CAPO' , 'ALAVANCA TAMPA', 'ALAVANCA MACANETA ABERTURA', 'ENCOSTO TRINCO QUEBRA VENTO', 'FECHO TRINCO VIDRO', 'FECHO TRINCO QUEBRA VENTO', 'FIXADOR TRINCO QUEBRA VENTO']},
            'macanetas': {'codigo': '0238', 'itens': ['COMANDO MACANETA', 'CONJUNTO MACANETA', 'GATILHO MACANETA', 'MACANETA', 'MACANETA PORTA', 'MACANETA EXTERNA', 'MACANETA INTERNA', 'MACANETA PORTA', 'MACANETA TAMPA']},
        }
    },
    'maquinas_vidro': {
        'codigo': '0070',
        'subgrupos': {
            ...
            'componentes_maquina_vidro': {'codigo': '0234', 'itens': ['CHUMBINHO MAQUINA DE VIDRO', 'DESLIZE MAQUINA DE VIDRO']},
        }
    },
    'pinos_dobradicas': {
        'codigo': '0068',
