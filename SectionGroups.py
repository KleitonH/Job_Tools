...
#MECÂNICA - 5048
    ...
    'cabos': {
        'codigo': '0021',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['CABO ACIONADOR PORTINHOLA', 'CABO AR FORCADO', 'CABO PORTA CORRER', 'CABO PORTA MALA', 'CABO PORTINHOLA', 'CABO TEMPERATURA', 'PARAFUSO QUEBRA GALHO CABO ACELERADOR', 'PINO TRAVA PORTINHOLA', 'SUPORTE CABO EMBREAGEM', 'SUPORTE CABO', 'TAMPA PORTINHOLA']},
    ...
    'combustivel': {
        ...
        'subgrupos': {
            ...
            'tanque_combustivel': {'codigo': '0151', 'itens': ['TANQUE COMBUSTIVEL', 'CILINDRO GNV', 'RESERVATORIO GASOLINA']},
        }
    },
    'correias': {
        'codigo': '0023',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['CORREIA VENTOINHA', 'KIT CORREIA E TENSOR', 'PARAFUSO TENSOR CORREIA', 'CORRENTE COMANDO', 'KIT CORRENTE COMANDO', 'SUPORTE CORREIA']},
    ...
    'direcao': {
        ...
        'subgrupos': {
            ...
            'setor_direcao': {'codigo': '0026', 'itens': ['SETOR', 'SETOR DIRECAO', 'SETOR RECON']},
    ...
    'juntas_retentores': {
        ...
        'subgrupos': {
            ...
            'retentores_eixo': {'codigo': '0045', 'itens': ['RETENTOR CAIXA DIRECAO', 'RETENTOR CUBO RODA', 'RETENTOR EIXO', 'RETENTOR EXTERNO RODA', 'RETENTOR INTERNO RODA', 'RETENTOR PINO MESTRE', 'RETENTOR POLIA', 'RETENTOR RODA DIANT', 'RETENTOR RODA EIXO', 'RETENTOR RODA TRAS', 'RETENTOR SEMI EIXO', 'RETENTOR SETOR', 'RETENTOR TRASEIRO INTERNO EIXO','RETENTOR VOLANTE']},
            ...
            'retentores_suspensao': {'codigo': '0389', 'itens': ['RETENTOR SUSPENSAO']},
    ...
    'reparos': {
        ...
        'subgrupos': {
            ...
            'kit_reparo_setor': {'codigo': '0088', 'itens': ['ACOPLAMENTO SETOR', 'GUIA SETOR DIRECAO', 'PINHAO SETOR', 'REPARO COLUNA DIR', 'REPARO CIL RODA', 'REPARO CILINDRO MESTRE', 'REPARO CILINDRO RODA', 'REPARO COLUNA', 'REPARO PARCIAL CIL RODA', 'REPARO SETOR']},
    ...
    'reservatorios': {
        ...
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': []},
            'reservatorios_agua': {'codigo': '0390', 'itens': ['RESERV AGUA', 'RESERVATORIO AGUA', 'RESERVATORIO AGUA PARABRISA', 'RESERV PARABRISA', 'RESERV RADIADOR']},
            'reservatorios_freio': {'codigo': '0391', 'itens': ['RESERVATORIO LIQUIDO FREIO']},
        }
    },
    'rolamentos_tensores_polias': {
        ...
        'subgrupos': {
            ...
            'polias': {'codigo': '0064', 'itens': ['CHAVETA FRESADA POLIA', 'POLIA ALTERNADOR', 'POLIA ALT', 'POLIA AUXILIAR', 'POLIA BOMBA AGUA', 'POLIA BOMBA DIR', 'POLÇIA BOMBA DIRECAO HIDRAULICA', 'POLIA CORREIA', 'POLIA DIRECAO', 'POLIA VENTILADOR', 'POLIA RODA LIVRE', 'POLIA TENSOR', 'POLIA VIRAB', 'POLIA VIRABREQUIM', 'SOBREPOLIA AR COND', 'POLIA MANIVELA MOTOR']},
        }
    },
    'suspensao': {
        'codigo': '0033',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['EMBUCHAMENTO', 'CALCO AJUSTE', 'CALCO AMORT', 'CALCO BATENT', 'CALCO CAMBAGEM', 'CUPILHA', 'EIXO BANDEJA TRAS', 'EIXO TENSOR', 'ESPACADOR ANEL VEDADOR', 'ESPACADOR ROLAMENTO', 'FACAO SUSPENS', 'MONTANTE', 'PARAFUSO BANDEJA', 'PARAFUSO CAMBAGEM', 'PARAFUSO EIXO TRAS', 'PORCA AMORTECEDOR', 'SUPORTE AMORTECEDOR DIANT', 'TELEFONE PINO ROLAMENTO', 'TIRANTE SUSPENSAO', 'SUPORTE BARRA TENSORA', 'SUPORTE SUSPENSAO']},
            ...
            'molas': {'codigo': '0115', 'itens': ['MOLA ESPORTIVA', 'MOLA SUSPENSAO', 'FEIXE MOLA', 'MOLA DIANT', 'MOLA DIANTEIRA', 'MOLA SUSPENSAO DIANTEIRA', 'MOLA SUSPENSAO TRASEIRA', 'MOLA TRAS', 'MOLA TRASEIRA', 'PAR MOLA TRAS']},
...
#Elétrica
    ...
    'iluminacao': {
        ...
        'subgrupos': {
            ...
            'soquetes': {'codigo': '0217', 'itens': ['CHICOTE COM RABICHO', 'SOQUETE', 'SOQUETE CIRCUITO', 'SOQUETE FAROL', 'SOQUETE LAMPADA 2 POLOS', 'SOQUETE GLOBO', 'SOQUETE LAMPADA', 'SOQUETE LAMPADA PINGO', 'SOQUETE LANTERNA', 'SOQUETE LANTERNA DIANTEIRA', 'SOQUETE LISO', 'SOQUETE MEIA LUZ', 'SOQUETE METAL', 'SOQUETE MIRIM', 'SOQUETE PAINEL', 'SOQUETE PINGO', 'SOQUETE PISCA', 'SOQUETE UNIVERSAL']},
        }
    },
    'injecao': {
        'codigo': '0043',
    ...
    'ignicao': {
        'codigo': '0048',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['BUCHA ACABAMENTO CABO VELA', 'BUCHA PARTIDA FRIO', 'CARVAO TAMPA DISTRI', 'CHAVE IGNICAO', 'CHAVE VIRGEM', 'CONTRA CAPA CHAVE ALARME', 'CONTROLE ALARME', 'IMPULSOR PARTIDA', 'KIT TUCHO VELA', 'PARAFUSO REGULAGEM PARTIDA', 'PULA MACACO VELA', 'BOBINA IMPULSIONADORA']},
    ...
    'modulos': {
        'codigo': '0049',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['GERENCIADOR GNV', 'MODULO AIR BAG', 'PARAFUSO ANTI FURTO', 'PORCA FIXACAO MODULO', 'MODULO ENGATE REBOQUE']},
    ...
    'bombas_eletricas': {
        'codigo': '0053',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['KIT BOMBA INJECAO COMBUSTIVEL']},
    ...
    'ventilacao_eletrica': {
        ...
        'subgrupos': {
            ...
            'eletroventiladores': {'codigo': '0183', 'itens': ['ELETROVENTILADOR', 'VENTILADOR CONDENSADOR', 'CUBO VISCOSO']},
            'eletrobombas': {'codigo': '0185', 'itens': ['ELETROBOMBA', 'ELETROBOMBA BICO']},
            'helices': {'codigo': '385', 'itens': ['HELICE']},
    ...
    'reguladores': {
        ...
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': []},
            'reguladores_pressao': {'codigo': '0213', 'itens': ['REGULADOR PRESSAO', 'REGULADOR GNV']},
...
#FERRAGENS
    ...
    'parafusos_porcas__medida': {
        ...
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': []},
            'parafusos_media': {'codigo': '0251', 'itens': ['PARAFUSO 10X', 'PARAFUSO 8X', 'PARAFUSO AFINACAO BATERIA', 'PARAFUSO SEXTAVADO',' PARAFUSO SOBERBO', 'PARAFUSO BARRA ROSQUEADA', 'PARAFUSO GAIOLA VALVULA', 'PARAFUSO VIRABREQUIM']},
...
#PLÁSTICOS
    'acessorios_externos': {
        ...
        'subgrupos': {
            ...
            'pretetores_paralama': {'codigo': '0315', 'itens': ['CAIXA DE RODA', 'PROTETOR PARALAMA', 'PROTETOR INTERNO PARALAMA']},
            'protetores_parachoque': {'codigo': '0384', 'itens': ['PROTETOR PARACHOQUE']},
    ...
    'guarnicoes': {
        ...
        'subgrupos': {
            ...
            'borrachas_cofre_motor': {'codigo': '0279', 'itens': ['BORRACHA CAPO/MOTOR', 'BORRACHA COFRE MOTOR', 'BORRACHA MOTOR', 'PROTETOR LATERAL MOTOR']},
...
#LATARIAS
    ...
    'capos': {
        'codigo': '0093',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['PROTETOR MOLA CAPO']},
...
#ACESSORIOS
    ...
    'protetores_motor': {
        ...
        'subgrupos': {
            ...
            'protetores_carter': {'codigo': '0318', 'itens': ['PROTETOR CARTER', 'PROTETOR MOTOR']}, 
        }
    },
    'spoilers': {
        'codigo': '0119',
