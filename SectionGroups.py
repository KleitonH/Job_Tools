...
#MECÂNICA
    'ar_condicionado': {
        'codigo': '0037',
        'subgrupos': {
            'default': {'codigo': '0001', 'itens': ['CONJUNTO EMBREAGEM COMPRESSOR', 'MAGNETICO COMPRESSOR', 'COMPRESSOR AR CONDICIONADO']},
        }
    },
    'arrefecimento': {
        'codigo': '0020',
    ...
    'suspensao': {
        ...
        'subgrupos': {
            ...
            'coxins': {'codigo': '0078', 'itens': ['CALCO AMORTECE', 'SEDE ROLAMENTO SUSP', 'COXIM AMORT', 'COXIM AMORTECEDOR', 'COXIM BR OSCI', 'COXIM BRACO OSCIL', ' COXIM CABINE', 'COXIM LIMITADOR TORCAO', 'COXIM ESTABILIZADOR', 'COXIM SUSP', 'CAPA SUSPENSAO', 'COXIM CABINE', 'COXIM LIMITADOR SUSPENSAO']}, 'COXIM TRASEIRA BANDEJA'
